...
<div id="content">
	...
	<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="/notice/view_notice?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.title}" /></a>
								</td>
					...
					<td align="right" colspan="4"><button type="button" id="button3"onclick="location='write_notice'">글쓰기</button></td>
					</c:if>
					</tr>
					</table>
