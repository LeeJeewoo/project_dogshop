      ...
      <tbody>
					<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="/board/view_qna?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.title}" /></a>
								</td>
					...
					<table border=0>
						...
						<script>
							 $(function(){
				      		...
				      		<td align="right" colspan="4"><button type="button" id="button3"onclick="location='write_qna'">글쓰기</button></td>
				      	</tr>
