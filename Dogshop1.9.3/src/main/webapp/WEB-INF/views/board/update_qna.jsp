...
$(document).ready(function(){
	...
	$(".cancel_btn").on("click", function(){
		...
		location.href = "/board/view_qna?bno=${update.bno}"
			   + "&page=${scri.page}"
...
<table class="update">
     ...
     <!--  <tr>
      총 15열
                <th colspan="1" scope="cols">분류</th>
                
                <th colspan="14" scope="cols">제목</th>
      ...
      <tbody>
		...
		<tr>
			...
			<td align="left"><input type="text" id="writer" name="writer" value="${update.writer}" readonly="readonly"/></td>
		</tr>
		<tr>
			<td>
