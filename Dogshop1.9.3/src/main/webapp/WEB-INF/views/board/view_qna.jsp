...
/* ################################################################################################### */
		$(document).ready(function(){
			...
			$(".update_btn").on("click", function(){
				formObj.attr("action", "/board/update_qna");
			...
			$(".list_btn").on("click", function(){
				...
				location.href = "/board/qnalist?page=${scri.page}"
...
<div id="content">
	<div class="container">
		...
		<table class="view1">
			...
			<tr>
				<td colspan=2><c:out value="${read.content}" escapeXml="false" /></div></td>
			</tr>
		...
		<div class="buttongroup">
			...
			<%-- <section id="container">
				...
				<div class="form-group">
					...
					<textarea id="content" name="content" class="form-control" readonly="readonly"wrap="hard"><c:out value="${read.content}" /></textarea>
				</div>
				<div class="form-group">
	 ...
	 --%>					
			...
			<form name="replyForm" method="post" class="form-horizontal">
				...
				<table class = "view3">
					<tr>			
						<td class="title3">
						&nbsp;작성자 :<input type="text" placeholder="작성자이름" id="writer" name="writer"value="${member.userId}" readonly/>
						</td>
					</tr>
					<tr>
						<td class="content3">
